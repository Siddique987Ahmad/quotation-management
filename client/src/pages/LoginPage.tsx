...
const LoginCompanyLogo: React.FC<{ className?: string }> = ({
  className = "w-16 h-16",
}) => {
  ...
  const logoUrl = companySettings?.logo
    ? `${
        ...
        (window.location.hostname === "localhost"
          ? "http://localhost:5000"
          : "http://148.230.82.188:5000")
      }${companySettings.logo}?t=${Date.now()}`
    : null;
        ...
        <img
          ...
          onError={(e) => {
            ...
            if (parent && !parent.querySelector(".logo-fallback")) {
              ...
              fallback.className =
                "logo-fallback w-full h-full bg-blue-600 flex items-center justify-center";
